...
- **Headless** (`claude -p`, invoked by the `coaching-notify` orchestrator): emit the digest on stdout and stop. The orchestrator appends the GitHub link line and ships it.
