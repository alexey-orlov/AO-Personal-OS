...
- `automations/telegram-inbox/` — launchd watcher that saves anything Alex posts in the **📥 Drop Zone** topic of the Telegram notification group into `inbox/` (text → `.md`, files/photos/voice → downloaded). See its `README.md`.
