...
**Mini-example (the whole mechanism on four numbers).** New private-cloud sales ₴10M/yr; hunter salaries ₴4M/yr; farmer/AM salaries ₴1M/yr; a cloud's COGS ₴10,000/yr; wanted profit 10%. Hunters: their year buys a cohort that pays 4 years → rate = 4M ÷ (10M × 4) = **10% of price**. Farmers: they serve the whole living portfolio (4 stacked cohorts = ₴40M/yr billings) → 1M ÷ 40M = **2.5%**. Price = 10,000 ÷ (1 − 0.10 − 0.025 − 0.10) = **₴12,903** (add ₴2,903: sales 1,290 + retention 323 + profit 1,290). Check: the ₴40M portfolio yields 10% = 4M = hunter budget, 2.5% = 1M = farmer budget, 10% = 4M profit, 77.5% = 31M = COGS of 3,100 clouds — exact. Two classic mistakes this avoids: "sales are 40% of annual sales → add 40%" (over-collects 4× because the customer pays 4 years), and adding %s to COGS instead of dividing the price (profit is % of price, not a markup on cost).
