...
Exposure to AI architectures we design for different customers
...
Pricing / estimating approach: 
do we really need fixed prices for services? Do we typically do that?
what do we need to offer Oracle? Cheapest reasonable option or risk averse option?
Current terms? Do we have estimates? Who should do that?
What do we present
...
Context metadata creation and maintenance
Feature repository
