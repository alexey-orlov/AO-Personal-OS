...
- Gero (Gero Gunkel) — AIDP sponsor/host; ex-Head of AI at Zurich Insurance — high-credibility champion but (inferred) a senior IC, not the economic buyer; owns the NHS / DHL NDA chase. Profile → [oracle-team.md](oracle-team.md). [AIDP sales call](calls/oracle/2026-06-12_173159_sales-call_2026061216024378A29A99.md)
