...
|---|---|---|---|
| [SoftServe](areas/softserve/README.md) | ramping in: part-time R&D product lead + agentic SME; onboarding into the Oracle productization workstream (Gero = owner, discovery call being set up) | [oracle](areas/softserve/oracle.md) · [iris-bootcamp](areas/softserve/iris-bootcamp.md) · [jumpstart-pm](areas/softserve/jumpstart-pm.md) | 2026-06-18 |
