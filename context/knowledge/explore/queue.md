...
- [ ] 2026-08-22 — Ray Dalio — world power clusters/order — Dalio's framework for how nations/empires cluster and cycle through rising and declining power (from "The Changing World Order"); raw drop garbled by voice transcription ("рей даль мировые кластеры" — inferred as "Рэй Далио, мировые кластеры") ([drop](../../_inbox/processed/tg-20260822-151809-396.md)) → [brief](briefs/ray-dalio-world-power-clusters.md)
- [ ] 2026-07-08 — ethics & meaning across science, business, and art — is science ethical? is business ethical? is art ethical? where does meaning come from in each domain; wants philosophical framings + further reading ([drop](../../_inbox/processed/tg-20260708-174023-197.md)) → [brief](briefs/ethics-and-meaning-science-business-art.md)
- [ ] 2026-07-03 — agentic AI frameworks landscape (2026) — 10 agentic AI frameworks and the layers/purposes they cover; wants a systemic view / map of the space ([drop](../../_inbox/processed/tg-20260703-182932-183.md)) → [brief](briefs/agentic-ai-frameworks-landscape-2026.md)
