...
- [ ] 2026-08-15 — team/personal "AI work OS" products — ready-made alternatives (UI + harness + guardrails) to the hand-rolled Claude Code OS: shared team skills, shared context, self-learning; for own teams, client deployments, and personal use (chat) → [brief](briefs/team-ai-work-os-products.md)
