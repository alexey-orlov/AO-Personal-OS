...
## Open questions
- ⚠️ At 36/30 insight limit (6 over!) — split candidate: "Loop design & delegation" cluster (`pi-JoXbk2fm7jM-*`, `pi-XWpTgCvgYaE-01..04`, `pi-rYX6m4gIys0-*`, `pi-RdalLtvn2-M-02..05`) vs. "Production infra & verification" cluster (architectural boundaries, security proxy, eval, RAG, guardrail insights). Review at next recluster run (bi-weekly, 11th or 25th).
