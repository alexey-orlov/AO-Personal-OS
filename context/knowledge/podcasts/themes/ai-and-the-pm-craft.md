...
related: [Leaders' value is choosing sources and target story form](#leaders-value-is-choosing-sources-and-target-story-form) (Matthew curates which sources and output forms; Ambrosino curates which of many experiments to ship — same curation bottleneck at different abstraction levels) · [Human judgment prevents 'AI slop' and remains essential](#human-judgment-prevents-ai-slop-and-remains-essential) (Foster's AI-slop warning is the same taste-is-non-automatable rule, framed as a PM-skill-rubric requirement)
...
— corroborated: Lenny's Podcast · 2026-09-06 · guest: Anish Acharya (a16z) · [▶ video](https://www.youtube.com/watch?v=LdIyXiq2DTY) · `pi-LdIyXiq2DTY-04`
...
### Build and ship small things constantly to learn AI product muscle
...
— Lenny's Podcast · 2026-09-06 · guest: Anish Acharya (a16z) · [▶ video](https://www.youtube.com/watch?v=LdIyXiq2DTY) · `pi-LdIyXiq2DTY-05`
...
### AI mastery is now a baseline expectation for PMs
...
— Aakash Gupta · 2026-09-24 · guest: Wade Foster (Zapier) · [▶ video](https://www.youtube.com/watch?v=WbvJMnlB6wA) · `pi-WbvJMnlB6wA-01`

### Transformational PMs build agent-driven product factories
...
— Aakash Gupta · 2026-09-24 · guest: Wade Foster (Zapier) · [▶ video](https://www.youtube.com/watch?v=WbvJMnlB6wA) · `pi-WbvJMnlB6wA-02`
related: theme → [Agent delegation, loops & software factories](agent-delegation-and-loops.md) (Zapier's nightly sifting-swarm-to-build-loop is the same software-factory pattern applied to product discovery)

### Human judgment prevents 'AI slop' and remains essential
