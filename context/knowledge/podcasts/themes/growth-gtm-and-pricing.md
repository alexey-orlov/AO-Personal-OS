...
_updated: 2026-09-18 · 81 insights from 51 episodes · (absorbed b2b-saas-and-scaling, 2026-06-11) — recluster (2026-08-25): split → enterprise-sales-playbook (Jen Abel's enterprise-sales tactics + the lighthouse/land-grab GTM framework) — ⚠ over budget (81/30), no clean seam found yet: the sales-team-scaling cluster (comp design, enablement, senior-hire timing) and the agent-in-GTM cluster (SDR/CS/AE agents, outbound revival) are candidate seams but each still spans too many pre-existing insights to split cleanly without a dedicated recluster pass; a new founder-led-outbound-craft cluster (targeting, messaging, follow-up cadence, reply-rate diagnostics — 5 insights as of 2026-09-13) is a third candidate seam, not yet at the ~8-insight split bar
