...
- The next `/context-update` sweep reads everything here, folds it into the relevant `context/projects/` page(s), then moves the file to `inbox/processed/` (also local-only; safe to empty whenever).
