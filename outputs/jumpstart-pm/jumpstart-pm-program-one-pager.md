...
- Lenny's Newsletter — *AI tools are overdelivering: results from our large-scale AI productivity survey* (1,750 respondents): <https://www.lennysnewsletter.com/p/ai-tools-are-overdelivering-results> — PM top uses (PRDs 21.5%, prototypes 19.8%), the research gap (+27pp desired-vs-actual), 15–25% execution compression.
...
- MIT NANDA — *The GenAI Divide: State of AI in Business 2025* (95% of pilots show no P&L impact; learning gap; partner-built tooling ~67% success vs ~22% internal; line managers drive adoption): report PDF <https://mlq.ai/media/quarterly_decks/v0.1_State_of_AI_in_Business_2025_Report.pdf>; summary <https://fortune.com/2025/08/18/mit-report-95-percent-generative-ai-pilots-at-companies-failing-cfo/>
...
- DORA — *The ROI of AI-assisted Software Development*: <https://dora.dev/ai/roi/report/> — J-curve, −15% dip default, enablement shortening recovery; calculator: <https://dora.dev/ai/roi/calculator/>
- SoftServe × MIT Technology Review — *Redefining the Future of Software Engineering* (Apr 2026): <https://www.softserveinc.com/en-us/news/agentic-engineering-global-study-softserve-mit> — leaders/laggards plays, 10–15% protected adoption time.
