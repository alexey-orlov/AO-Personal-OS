...
| `#/sellers` | **For sellers** (round 8, `docs/PROVENANCE.md` §24): the sales-kit request for all offers or one product — a SoftServe or Oracle work email gets the kit; customers and partners are routed to the scoping call — plus *See the fit in an account?*, which opens the demo form. Reached from the footer's link row and from every product's *For sellers* tab; not in the header (removed 2026-09-17). |
