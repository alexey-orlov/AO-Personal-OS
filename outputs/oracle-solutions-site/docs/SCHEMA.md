...
| `nav` | `[{ label, route }]` | **Exactly two, in this order: Products (`#/products`) · Services (`#/services`).** *Case studies* left the header on 2026-09-17 (Alex) — the home page keeps its case-study screen, and Services links to it. There is no *Overview* item — the lockup is the home link (round 5). `check-grammar.js` asserts both labels and both routes. |
