...
(function () {
  ...
  var STEPS = [
    ...
    { id: "explore", major: 4, side: "left",
      ...
      body: "One row is flagged for review. Open it: two source records, one in Fusion and one in JD Edwards, the evidence the model matched them on, and the reason it will not stand on its own.",
      target: function () { return $("[data-orion-btn]"); }, anchor: function () { return $('tr[data-orion] td:last-child'); },
      before: function () { S.panel = null; renderWb(); },
