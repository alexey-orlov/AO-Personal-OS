...
window.WFO_DATA = (function () {
  ...
  var V = [
    [[-40, -40], [250, -30], [520, -45], [770, -35], [1040, -40]],
    [[-40, 120], [240, 135], [510, 100], [750, 145], [1040, 120]],
    [[-40, 240], [220, 255], [535, 225], [730, 268], [1040, 235]],
    [[-40, 372], [245, 352], [505, 378], [765, 342], [1040, 368]]
  ];
  var H = [], W = [];
  ...
  H[3][2] = [640, 300]; /* the harbour inlet */
  ...
  var map = {
    w: 1000, h: 420,
    sea: coast.concat([[1040, 460], [-40, 460]]),
    river: "M310,-40 C340,40 330,120 400,165 C470,210 520,240 575,285 C600,300 620,298 640,300",
    ring: { cx: 500, cy: 175, rx: 330, ry: 150 },
    roads: [[[500, 175], [300, -40]], [[500, 175], [740, -40]], [[500, 175], [120, 372]], [[500, 175], [880, 362]], [[-40, 190], [1040, 165]]],
    places: [["Harbour", 655, 335], ["Ring road", 500, 20], ["North Hills", 500, -20]]
  };
  ...
  var settings = {
    ...
    rules: [
      ...
      { name: "Zone-level demand", type: "Soft", desc: "Coverage follows booked visits; sparse dates are backfilled from last year's demand for the same period." },
